...
$('#films .select_list button').click(function(){
    if($(this).children('.clone_down').css('display') == 'block'){
        $(this).children('.dropdown_arrow').removeClass('down');
        $(this).children('.dropdown_arrow').addClass('up');
        $(this).children('.clone_down').css('display','none');
        $(this).children('.clone_up').css('display','block');
        $(this).next('.dropdown_select_list').css( "display", "block" );
    }
    else{
        $(this).children('.dropdown_arrow').removeClass('up');
        $(this).children('.dropdown_arrow').addClass('down');
        $(this).children('.clone_down').css('display','block');
        $(this).children('.clone_up').css('display','none');
        $(this).next('.dropdown_select_list').css( "display", "none" );
    }
})
